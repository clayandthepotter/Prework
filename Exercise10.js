...
* 1. Create a username for the user that is the email address up to (but not including) the @ symbol. 
* 2. Create a new email for the user that replaces their old domain with 'codecorps.com'.
* 3. Create a temporary password for the user that is the first five letters of their username followed by the length of their original email address.*/
