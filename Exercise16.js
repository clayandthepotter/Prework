...
while(word.includes("p")) { //condition is true as long as word contains i
    word = word.replace("p", "_");  //replaces the first i it finds with an underscore and the sets word equal to replaced version
}
